...
class FundedSociety : Society
{
    ...
    public FundedSociety(string name, string contact, float fundingAmount)
        : base(name, contact)
    {
...
class UnfundedSociety : Society
{
    public UnfundedSociety(string name, string contact)
        : base(name, contact)
    {
    }
}
        ...
        while (true)
        {
            ...
            switch (choice)
            {
                case 1:
                    ...
                    {
                        var unfundedSociety = new UnfundedSociety(name, contact);
